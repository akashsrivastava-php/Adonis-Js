...
Route.group(() => {
  ...
  Route.get('/add-quiz', 'App/Controllers/Http/Admin/QuizController.addQuiz')
  Route.post('/insert-quiz', 'App/Controllers/Http/Admin/QuizController.insertQuiz')
  Route.get('/list-quiz/:page?', 'App/Controllers/Http/Admin/QuizController.listQuiz')
  Route.get('/edit-quiz/:id', 'App/Controllers/Http/Admin/QuizController.editQuiz')
  Route.post('/update-quiz/:id', 'App/Controllers/Http/Admin/QuizController.updateQuiz')
  Route.get('/delete-quiz/:id', 'App/Controllers/Http/Admin/QuizController.deleteQuiz')
  Route.get('/quiz-question-list/:id', 'App/Controllers/Http/Admin/QuizController.listQuestion')
  Route.get('/quiz-question-add/:id', 'App/Controllers/Http/Admin/QuizController.addQuestion')
  Route.post('/insert-question', 'App/Controllers/Http/Admin/QuizController.insertQuestion')
  Route.get('/edit-question/:id', 'App/Controllers/Http/Admin/QuizController.editQuestion')
  Route.post('/update-question/:id', 'App/Controllers/Http/Admin/QuizController.updateQuestion')
  Route.get('/delete-question/:id', 'App/Controllers/Http/Admin/QuizController.deleteQuestion')
